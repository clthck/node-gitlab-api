...
var GroupMilestoneMergeRequests = function (_BaseModel) {
  _inherits(GroupMilestoneMergeRequests, _BaseModel);

  function GroupMilestoneMergeRequests() {
    _classCallCheck(this, GroupMilestoneMergeRequests);

    return _possibleConstructorReturn(this, (GroupMilestoneMergeRequests.__proto__ || Object.getPrototypeOf(GroupMilestoneMergeRequests)).apply(this, arguments));
  }

  _createClass(GroupMilestoneMergeRequests, [{
    key: 'all',
