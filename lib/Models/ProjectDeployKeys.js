...
var ProjectKeys = function (_BaseModel) {
  _inherits(ProjectKeys, _BaseModel);

  function ProjectKeys() {
    _classCallCheck(this, ProjectKeys);

    return _possibleConstructorReturn(this, (ProjectKeys.__proto__ || Object.getPrototypeOf(ProjectKeys)).apply(this, arguments));
  }

  _createClass(ProjectKeys, [{
    key: 'listKeys',
