...
var GroupMilestones = function (_BaseModel) {
  _inherits(GroupMilestones, _BaseModel);

  function GroupMilestones() {
    var _ref;

    _classCallCheck(this, GroupMilestones);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    var _this = _possibleConstructorReturn(this, (_ref = GroupMilestones.__proto__ || Object.getPrototypeOf(GroupMilestones)).call.apply(_ref, [this].concat(args)));
